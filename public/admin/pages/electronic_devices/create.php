        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title"> إضافة الأجهزه الإلكترونية</h3>
            </div>
            ...
            <div class="card-body">
              ...
              <form id="quickForm" action="<?= getController("admin/electronic_devices/create.php") ?>" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
