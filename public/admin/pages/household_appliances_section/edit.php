...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $oldData = selectWhere($conn, 'household_appliances_section', '*', "id = $id")[0];
}
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <h3 class="card-title">تعديل  الأدوات المنزلية</h3>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form id="quickForm" action="<?= getController("admin/household_appliances_section/update.php") ?>" method="POST"  enctype="multipart/form-data">
                                <div class="card-body">
